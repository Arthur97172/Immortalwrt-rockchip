...
# --- 磁盘与文件系统支撑 (非常适合 Rockchip 这种带 USB/SATA 的设备) ---
...
# --- 瑞芯微硬件相关驱动 (保留核心，剔除冲突项) ---
PACKAGES="$PACKAGES kmod-dwmac-rockchip kmod-ata-ahci kmod-ata-dwc kmod-mmc kmod-r8125 kmod-r8168 kmod-r8169 r8152-firmware"
# 如果你的设备有无线网卡，保留常见的适配器驱动
PACKAGES="$PACKAGES kmod-rtw88-8822ce kmod-rtw88-8821ce kmod-mt7921e kmod-ath10k"

# --- 网络核心 (强制替换默认 dnsmasq 为 full 版) ---
...
# --- 应用层与插件 (已剔除 linkease/iStore 等冲突私有包) ---
...
# --- 移除报错的无线冲突项 ---
# 原列表中 wpad-openssl 和 hostapd-openssl 冲突，保留 wpad 即可
